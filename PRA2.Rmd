...
TODO######### código para la correlación
```{r message= FALSE, warning=FALSE}
...
TODO#########################Graficas histogŕamas y q-q
...
|-----------------------------|------------------------------------------|
| Investigación Previa        | Alexis Arroyo, Gabriel Pulido de Torres  |
| Redacción de las respuestas | Alexis Arroyo, Gabriel Pulido de Torres  |
| Desarrollo código           |  Alexis Arroyo, Gabriel Pulido de Torres |
